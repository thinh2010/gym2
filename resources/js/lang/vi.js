export default {
  ...
  route: {
    ...
    blocks: 'Blocks',
    addBlock: 'Thêm mới Block',
    editBlock: 'Sửa Block',
    addBlockContent: 'Thêm mới Block con',
    editBlockContent: 'Sửa Block con',
    blogs: 'Blogs',
    blogCategories: 'Danh mục Blog',
    addBlogCategory: 'Thêm danh mục Blog',
    editBlogCategory: 'Sửa danh mục Blog',
    blogArticles: 'Bài viết Blog',
    addBlogArticle: 'Thêm bài viết Blog',
    editBlogArticle: 'Sửa bài viết Blog',
    faqs: 'Faqs',
    faqCategories: 'Danh mục Blog',
    addFaqCategory: 'Thêm danh mục Faq',
    editFaqCategory: 'Sửa danh mục Faq',
    faqArticles: 'Bài viết Faq',
    addFaqArticle: 'Thêm bài viết Faq',
    editFaqArticle: 'Sửa bài viết Faq',
    settings: 'Cài đặt',
