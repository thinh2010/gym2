...
(function(a, b){
  function cy(a){
    ...
    if (!cj[a]){
      var b = c.body, d = f('<' + a + '>').appendTo(b), e = d.css('display'); d.remove(); if (e === 'none' || e === ''){
        ck || (ck = c.createElement('iframe'), ck.frameBorder = ck.width = ck.height = 0), b.appendChild(ck); if (!cl || !ck.createElement){
    ...
    f = f || c.dataTypes[0], g = g || {}, g[f] = !0; var h = a[f], i = 0, j = h ? h.length : 0, k = a === bS, l; for (;i < j && (k || !l); i++){
    ...
    return function(b, c){
      typeof b !== 'string' && (c = b, b = '*'); if (f.isFunction(c)){
        var d = b.toLowerCase().split(bO), e = 0, g = d.length, h, i, j; for (;e < g; e++){
    ...
    var b = g[a] = {}, c, d; a = a.split(/\s+/); for (c = 0, d = a.length; c < d; c++){
      ...
      function J(){
        ...
        if (!A){
          A = e.Callbacks('once memory'); if (c.readyState === 'complete') {
            return setTimeout(e.ready, 1);
        ...
        if (c){
          var b = arguments, d = 0, e = b.length; for (;d < e; d++) {
            for (var f = 0; f < c.length; f++) {
              if (b[d] === c[f]){
                j && f <= l && (l--, f <= m && m--), c.splice(f--, 1); if (a.unique) {
                  break;
                }
              }
            }
    ...
    var b, d, e, g, h, i, j, k, l, m, n, o, p = c.createElement('div'), q = c.documentElement; p.setAttribute('className', 't'), p.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", d = p.getElementsByTagName('*'), e = p.getElementsByTagName('a')[0]; if (!d || !d.length || !e) {
      return {};
    ...
    if (f.acceptData(a)){
      var g, h, i, j = f.expando, k = typeof c === 'string', l = a.nodeType, m = l ? f.cache : a, n = l ? a[j] : a[j] && j, o = c === 'events'; if ((!n || !m[n] || !o && !e && !m[n].data) && k && d === b) {
        return;
      } n || (l ? a[j] = n = ++f.uuid : n = j), m[n] || (m[n] = {}, l || (m[n].toJSON = f.noop)); if (typeof c === 'object' || typeof c === 'function'){
        e ? m[n] = f.extend(m[n], c) : m[n].data = f.extend(m[n].data, c);
      }g = h = m[n], e || (h.data || (h.data = {}), h = h.data), d !== b && (h[f.camelCase(c)] = d); if (o && !h[c]) {
        return g.events;
      } k ? (i = h[c], i == null && (i = h[f.camelCase(c)])) : i = h; return i;
    }
  }, removeData: function(a, b, c){
    if (f.acceptData(a)){
      var d, e, g, h = f.expando, i = a.nodeType, j = i ? f.cache : a, k = i ? a[h] : h; if (!j[k]) {
        return;
      } if (b){
    ...
    if (a.nodeName){
      var b = f.noData[a.nodeName.toLowerCase()]; if (b) {
    ...
    var d = 2; typeof a !== 'string' && (c = a, a = 'fx', d--); if (arguments.length < d) {
  ...
  } }); var o = /[\n\t\r]/g, p = /\s+/, q = /\r/g, r = /^(?:button|input)$/i, s = /^(?:button|input|object|select|textarea)$/i, t = /^a(?:rea)?$/i, u = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, v = f.support.getSetAttribute, w, x, y; f.fn.extend({ attr: function(a, b){
    ...
    var c = typeof a, d = typeof b === 'boolean'; if (f.isFunction(a)) {
      ...
      if (c === 'string'){
        var e, g = 0, h = f(this), i = b, j = a.split(p); while (e = j[g++]){
      ...
      e = f.isFunction(a); return this.each(function(d){
        var g = f(this), h; if (this.nodeType === 1){
          e ? h = a.call(this, d, g.val()) : h = a, h == null ? h = '' : typeof h === 'number' ? h += '' : f.isArray(h) && (h = f.map(h, function(a){
            return a == null ? '' : a + '';
          })), c = f.valHooks[this.type] || f.valHooks[this.nodeName.toLowerCase()]; if (!c || !('set' in c) || c.set(this, h, 'value') === b) {
            this.value = h;
          }
        }
      });
    ...
    var b, c, d, e, g = a.selectedIndex, h = [], i = a.options, j = a.type === 'select-one'; if (g < 0) {
      return null;
    } c = j ? g : 0, d = j ? g + 1 : i.length; for (;c < d; c++){
    ...
    var g, h, i, j = a.nodeType; if (!!a && j !== 3 && j !== 8 && j !== 2){
      if (e && c in f.attrFn) {
        ...
        return f.prop(a, c, d);
      } i = j !== 1 || !f.isXMLDoc(a), i && (c = c.toLowerCase(), h = f.attrHooks[c] || (u.test(c) ? x : w)); if (d !== b){
        if (d === null){
    ...
    var h, i, j, k, l, m, n, o, p, q, r, s; if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))){
      d.handler && (p = d, d = p.handler, g = p.selector), d.guid || (d.guid = f.guid++), j = h.events, j || (h.events = j = {}), i = h.handle, i || (h.handle = i = function(a){
        ...
        l = A.exec(c[k]) || [], m = l[1], n = (l[2] || '').split('.').sort(), s = f.event.special[m] || {}, m = (g ? s.delegateType : s.bindType) || m, s = f.event.special[m] || {}, o = f.extend({ type: m, origType: l[1], data: e, handler: d, guid: d.guid, selector: g, quick: g && G(g), namespace: n.join('.') }, p), r = j[m]; if (!r){
          r = j[m] = [], r.delegateCount = 0; if (!s.setup || s.setup.call(a, e, n, i) === !1){
    ...
    if (!e || e.nodeType !== 3 && e.nodeType !== 8){
      var h = c.type || c, i = [], j, k, l, m, n, o, p, q, r, s; if (E.test(h + f.event.triggered)) {
        return;
      } h.indexOf('!') >= 0 && (h = h.slice(0, -1), k = !0), h.indexOf('.') >= 0 && (i = h.split('.'), h = i.shift(), i.sort()); if ((!e || f.event.customEvent[h]) && !f.event.global[h]) {
        return;
      } c = typeof c === 'object' ? c[f.expando] ? c : new f.Event(h, c) : new f.Event(h), c.type = h, c.isTrigger = !0, c.exclusive = k, c.namespace = i.join('.'), c.namespace_re = c.namespace ? new RegExp('(^|\\.)' + i.join('\\.(?:.*\\.)?') + '(\\.|$)') : null, o = h.indexOf(':') < 0 ? 'on' + h : ''; if (!e){
        ...
        return;
      } r = [[e, p.bindType || h]]; if (!g && !p.noBubble && !f.isWindow(e)){
    ...
    if (a[f.expando]) {
      return a;
    } var d, e, g = a, h = f.event.fixHooks[a.type] || {}, i = h.props ? this.props.concat(h.props) : this.props; a = f.Event(g); for (d = i.length; d;){
      e = i[--d], a[e] = g[e];
    ...
    function x(a, b, c, e, f, g){
      ...
      e = e || [], d = d || c; var h = d; if (d.nodeType !== 1 && d.nodeType !== 9) {
        ...
        return e;
      } var i, j, k, l, n, q, r, t, u = !0, v = m.isXML(d), w = [], x = b; do {
        ...
        if (w.length === 2 && o.relative[w[0]]){
          ...
          j = o.relative[w[0]] ? [d] : m(w.shift(), d); while (w.length){
        ...
        !f && w.length > 1 && d.nodeType === 9 && !v && o.match.ID.test(w[0]) && !o.match.ID.test(w[w.length - 1]) && (n = m.find(w.shift(), d, v), d = n.expr ? m.filter(n.expr, n.set)[0] : n.set[0]); if (d){
          n = f ? { expr: w.pop(), set: s(f) } : m.find(w.pop(), w.length === 1 && (w[0] === '~' || w[0] === '+') && d.parentNode ? d.parentNode : d, v), j = n.expr ? m.filter(n.expr, n.set) : n.set, w.length > 0 ? k = s(j) : u = !1; while (w.length){
      ...
      var f, g, h, i, j, k, l, n, p, q = a, r = [], s = c, t = c && c[0] && m.isXML(c[0]); while (a && c.length){
        for (h in o.filter) {
          if ((f = o.leftMatch[h].exec(a)) != null && f[2]){
            k = o.filter[h], l = f[1], g = !1, f.splice(1, 1); if (l.substr(l.length - 1) === '\\') {
              continue;
            } s === r && (r = []); if (o.preFilter[h]){
              f = o.preFilter[h](f, s, d, r, e, t); if (!f){
                g = i = !0;
              } else if (f === !0) {
                continue;
              }
              ...
              d || (s = r), a = a.replace(o.match[h], ''); if (!g) {
                return [];
              } break;
            }
          }
      ...
      throw new Error('Syntax error, unrecognized expression: ' + a);
        ...
        if (typeof b.getElementsByName !== 'undefined'){
          var c = [], d = b.getElementsByName(a[1]); for (var e = 0, f = d.length; e < f; e++){
        ...
        var b = a.getAttribute('type'), c = a.type; return a.nodeName.toLowerCase() === 'input' && c === 'text' && (b === c || b === null);
      }, radio: function(a){
        ...
        var b = a.nodeName.toLowerCase(); return (b === 'input' || b === 'button') && a.type === 'submit';
      }, image: function(a){
        return a.nodeName.toLowerCase() === 'input' && a.type === 'image';
      }, reset: function(a){
        var b = a.nodeName.toLowerCase(); return (b === 'input' || b === 'button') && a.type === 'reset';
      }, button: function(a){
        ...
        var c, e, f, g, h, i, j, k = b[1], l = a; switch (k){
          case 'only':case 'first':while (l = l.previousSibling) {
            if (l.nodeType === 1) {
              return !1;
            }
          } if (k === 'first') {
          ...
          } return !0; case 'nth':c = b[2], e = b[3]; if (c === 1 && e === 0) {
            return !0;
          } f = b[0], g = a.parentNode; if (g && (g[d] !== f || !a.nodeIndex)){
    ...
    }o.match.globalPOS = p; var s = function(a, b){
      ...
      } var c, d, e = [], f = [], g = a.parentNode, i = b.parentNode, j = g; if (g === i) {
        return v(a, b);
      } if (!g) {
        return -1;
      } if (!i) {
          ...
          e = e || c; if (!g && !m.isXML(e)){
            var h = /^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b); if (h && (e.nodeType === 1 || e.nodeType === 9)){
              ...
              if (b === 'body' && e.body) {
                ...
                var i = e.getElementById(h[3]); if (!i || !i.parentNode) {
                  return s([], f);
                } if (i.id === h[3]) {
                  return s([i], f);
                }
          ...
          c = c.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']"); if (!m.isXML(a)) {
            try {
              if (e || !o.match.PSEUDO.test(c) && !/!=/.test(c)){
                var f = b.call(a, c); if (f || !d || a.document && a.document.nodeType !== 11) {
                  return f;
                }
              }
            } catch (g){}
  ...
  } }); var V = 'abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video', W = / jQuery\d+="(?:\d+|null)"/g, X = /^\s+/, Y = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, Z = /<([\w:]+)/, $ = /<tbody/i, _ = /<|&#?\w+;/, ba = /<(?:script|style)/i, bb = /<(?:script|object|embed|option|style)/i, bc = new RegExp('<(?:' + V + ')[\\s/>]', 'i'), bd = /checked\s*(?:[^=]|=\s*.checked.)/i, be = /\/(java|ecma)script/i, bf = /^\s*<!(?:\[CDATA\[|\-\-)/, bg = { option: [1, "<select multiple='multiple'>", '</select>'], legend: [1, '<fieldset>', '</fieldset>'], thead: [1, '<table>', '</table>'], tr: [2, '<table><tbody>', '</tbody></table>'], td: [3, '<table><tbody><tr>', '</tr></tbody></table>'], col: [2, '<table><tbody></tbody><colgroup>', '</colgroup></table>'], area: [1, '<map>', '</map>'], _default: [0, '', ''] }, bh = U(c); bg.optgroup = bg.option, bg.tbody = bg.tfoot = bg.colgroup = bg.caption = bg.thead, bg.th = bg.td, f.support.htmlSerialize || (bg._default = [1, 'div<div>', '</div>']), f.fn.extend({ text: function(a){
    ...
    var g, h, i, j = []; b = b || c, typeof b.createElement === 'undefined' && (b = b.ownerDocument || b[0] && b[0].ownerDocument || c); for (var k = 0, l; (l = a[k]) != null; k++){
      typeof l === 'number' && (l += ''); if (!l) {
        continue;
      } if (typeof l === 'string') {
        if (!_.test(l)){
          l = b.createTextNode(l);
        } else {
          l = l.replace(Y, '<$1></$2>'); var m = (Z.exec(l) || ['', ''])[1].toLowerCase(), n = bg[m] || bg._default, o = n[0], p = b.createElement('div'), q = bh.childNodes, r; b === c ? bh.appendChild(p) : U(b).appendChild(p), p.innerHTML = n[1] + l + n[2]; while (o--){
            p = p.lastChild;
          } if (!f.support.tbody){
            var s = $.test(l), t = m === 'table' && !s ? p.firstChild && p.firstChild.childNodes : n[1] === '<table>' && !s ? p.childNodes : []; for (i = t.length - 1; i >= 0; --i){
      ...
      g = function(a){
        ...
        h = j[k]; if (e && f.nodeName(h, 'script') && (!h.type || be.test(h.type))){
  ...
  } }); var bp = /alpha\([^)]*\)/i, bq = /opacity=([^)]*)/, br = /([A-Z]|^ms)/g, bs = /^[\-+]?(?:\d*\.)?\d+$/i, bt = /^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i, bu = /^([\-+])=([\-+.\de]+)/, bv = /^margin/, bw = { position: 'absolute', visibility: 'hidden', display: 'block' }, bx = ['Top', 'Right', 'Bottom', 'Left'], by, bz, bA; f.fn.css = function(a, c){
    ...
    if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style){
      var g, h, i = f.camelCase(c), j = a.style, k = f.cssHooks[i]; c = f.cssProps[i] || i; if (d === b){
        ...
        return;
      } h === 'number' && !f.cssNumber[i] && (d += 'px'); if (!k || !('set' in k) || (d = k.set(a, d)) !== b) {
        try {
          j[c] = d;
        } catch (l){}
      }
  ...
  }); var bC = /%20/g, bD = /\[\]$/, bE = /\r?\n/g, bF = /#.*$/, bG = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, bH = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, bI = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, bJ = /^(?:GET|HEAD)$/, bK = /^\/\//, bL = /\?/, bM = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, bN = /^(?:select|textarea)/i, bO = /\s+/, bP = /([?&])_=[^&]*/, bQ = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bR = f.fn.load, bS = {}, bT = {}, bU, bV, bW = ['*/'] + ['*']; try {
    bU = e.href;
  } catch (bX){
    ...
    function w(a, c, l, m){
      ...
      return !1;
    } t = d.global, d.type = d.type.toUpperCase(), d.hasContent = !bJ.test(d.type), t && f.active++ === 0 && f.event.trigger('ajaxStart'); if (!d.hasContent){
  ...
  } }), f.extend({ active: 0, lastModified: {}, etag: {}}); var cc = f.now(), cd = /(\=)\?(&|$)|\?\?/i; f.ajaxSetup({ jsonp: 'callback', jsonpCallback: function(){
    ...
    var e = typeof b.data === 'string' && /^application\/x\-www\-form\-urlencoded/.test(b.contentType); if (b.dataTypes[0] === 'jsonp' || b.jsonp !== !1 && (cd.test(b.url) || e && cd.test(b.data))){
      var g, h = b.jsonpCallback = f.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, i = a[h], j = b.url, k = b.data, l = '$1' + h + '$2'; b.jsonp !== !1 && (j = j.replace(cd, l), b.url === j && (e && (k = k.replace(cd, l)), b.data === k && (j += (/\?/.test(j) ? '&' : '?') + b.jsonp + '=' + h))), b.url = j, b.data = k, a[h] = function(a){
        g = [a];
      }, d.always(function(){
    ...
    if (a.crossDomain){
      var d, e = c.head || c.getElementsByTagName('head')[0] || c.documentElement; return { send: function(f, g){
    ...
    } : !1, cf = 0, cg; f.ajaxSettings.xhr = a.ActiveXObject ? function(){
        ...
        var h = c.xhr(), i, j; c.username ? h.open(c.type, c.url, c.async, c.username, c.password) : h.open(c.type, c.url, c.async); if (c.xhrFields) {
          ...
          var j, k, l, m, n; try {
            if (d && (e || h.readyState === 4)){
              d = b, i && (h.onreadystatechange = f.noop, ce && delete cg[i]); if (e){
    ...
    } var d, e, g = 0, h = this.length; for (;g < h; g++){
    ...
    function g(){
      e.queue === !1 && f._mark(this); var b = f.extend({}, e), c = this.nodeType === 1, d = c && f(this).is(':hidden'), g, h, i, j, k, l, m, n, o, p, q; b.animatedProperties = {}; for (i in a){
        ...
        h = a[g], f.isArray(h) ? (b.animatedProperties[g] = h[1], h = a[g] = h[0]) : b.animatedProperties[g] = b.specialEasing && b.specialEasing[g] || b.easing || 'swing'; if (h === 'hide' && d || h === 'show' && !d) {
    ...
    function h(a){
      return e.step(a);
    } var e = this, g = f.fx; this.startTime = cq || cr(), this.end = c, this.now = this.start = a, this.pos = this.state = 0, this.unit = d || this.unit || (f.cssNumber[this.prop] ? '' : 'px'), h.queue = this.options.queue, h.elem = this.elem, h.saveState = function(){
    ...
    var b, c, d, e = cq || cr(), g = !0, h = this.elem, i = this.options; if (a || e >= i.duration + this.startTime){
      this.now = this.end, this.pos = this.state = 1, this.update(), i.animatedProperties[this.prop] = !0; for (b in i.animatedProperties){
        ...
        }), i.hide && f(h).hide(); if (i.hide || i.show) {
  ...
  }); var cv, cw = /^t(?:able|d|h)$/i, cx = /^(?:body|html)$/i; 'getBoundingClientRect' in c.documentElement ? cv = function(a, b, c, d){
    try {
      d = a.getBoundingClientRect();
    } catch (e){} if (!d || !f.contains(c, a)) {
      return d ? { top: d.top, left: d.left } : { top: 0, left: 0 };
    } var g = b.body, h = cy(b), i = c.clientTop || g.clientTop || 0, j = c.clientLeft || g.clientLeft || 0, k = h.pageYOffset || f.support.boxModel && c.scrollTop || g.scrollTop, l = h.pageXOffset || f.support.boxModel && c.scrollLeft || g.scrollLeft, m = d.top + k - i, n = d.left + l - j; return { top: m, left: n };
  } : cv = function(a, b, c){
    ...
    }f.support.fixedPosition && j.position === 'fixed' && (k += Math.max(c.scrollTop, h.scrollTop), l += Math.max(c.scrollLeft, h.scrollLeft)); return { top: k, left: l };
  }, f.fn.offset = function(a){
    if (arguments.length) {
      return a === b ? this : this.each(function(b){
        f.offset.setOffset(this, a, b);
      });
    } var c = this[0], d = c && c.ownerDocument; if (!d) {
      return null;
    } if (c === d.body) {
    ...
    if (!this[0]) {
      return null;
    } var a = this[0], b = this.offsetParent(), c = this.offset(), d = cx.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset(); c.top -= parseFloat(f.css(a, 'marginTop')) || 0, c.left -= parseFloat(f.css(a, 'marginLeft')) || 0, d.top += parseFloat(f.css(b[0], 'borderTopWidth')) || 0, d.left += parseFloat(f.css(b[0], 'borderLeftWidth')) || 0; return { top: c.top - d.top, left: c.left - d.left };
    ...
    var d = 'client' + a, e = 'scroll' + a, g = 'offset' + a; f.fn['inner' + a] = function(){
      ...
      return f.access(this, function(a, c, h){
        var i, j, k, l; if (f.isWindow(a)){
          ...
          i = a.documentElement; if (i[d] >= i[e]) {
            return i[d];
