...
<head>
    ...
    {{-- <script type="text/javascript" src="js/jquery-1.7.2.mina5c6.js?1562084590"></script>
    <script type="text/javascript" src="js/errora5c6.js?1562084590"></script> --}}
    <!--[if lt IE 9]>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('load', function load(event) {
            ...
            loadJS("/gym/img/svg/embed/grunticon.loader.js", function () {
                var embeddedSVGdir = '/img/svg/embed/index.html';
                grunticon([
...
<body class="body js-body">
    <div id="body">
        ...
        <form class="site-header-container">
            ...
            <header class="site-header">
                ...
                <nav class="nav nav-header caps">
                    <ul class="nav-header__list">
                        ...
                        <!--<li class="nav__item">
                    <a href="/pack-workouts" class="nav__link -desktop vertical-align-children">
                        <span class="nav-header__title">PACK45</span>
                    </a>
                </li>-->
                        <li class="nav__item">
            ...
            <!-- <div class="crowdfunding-banner">
        <p>BLACK FRIDAY SPECIAL OFFERS </p>
        <a href="/locations" class="btn -small -fill">Find out more</a>
    </div>-->
            <nav class="nav nav-menu -locations -menu">
                    ...
                    <div class="v-center">
                        ...
                        <ul class="nav-menu__list">
                            <li class="nav__item -beta -menu">
                                <a href="locations/gym-basildon.html">
                                    <span>Basildon</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="locations/gym-bradford.html">
                                    <span>Bradford</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="locations/gym-camberwell.html">
                                    <span>Camberwell</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="locations/gym-park-royal.html">
                                    <span>London Park Royal</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="locations/gym-slough.html">
                                    <span>Slough</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                ...
                <div class="nav-menu__inner">
                    <div class="v-center">
                        ...
                        <ul class="nav-menu__list">
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/bordeaux-chartrons/">
                                    <span>France Bordeaux Chartrons</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/bordeaux-merignac/">
                                    <span>France Bordeaux Mérignac</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/montimaron-beziers/">
                                    <span>France Montimaron Beziers </span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/montpellier-perols/">
                                    <span>France Montpellier Perols</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/Trifontaine/">
                                    <span>France Montpellier Trifontaine</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/perigueux-boulazac/">
                                    <span>France Périgueux-Boulazac</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/poitiers-universite/">
                                    <span>France Poitiers Universite</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/saint-gilles/">
                                    <span>France Saint Gilles</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/saint-jean-de-maurienne/">
                                    <span>France Saint-Jean-de-Maurienne</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/saint-medard-en-jalles/">
                                    <span>France Saint-Médard-en-Jalles</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="https://www.easygym.fr/salle-de-sport/vauvert/">
                                    <span>France Vauvert</span>
                                </a>
                            </li>
                            <li class="nav__item -beta -menu">
                                <a href="http://www.easygym.ke/">
            ...
            <nav class="nav nav-menu -site">
                <ul class="nav-menu__inner">
                    <li class="nav__item -hecto -menu">
                        <a href="membership.html" data-letters="Membership">
                            <span>Membership</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="locations.html" data-letters="Locations">
                            <span>Locations</span>
                        </a>
                    </li>
                    <!-- <li class="nav__item -hecto -menu">
                <a href="/pack-workouts" data-letters="PACK45P">
                    <span>PACK45</span>
                </a>
            </li>-->
                    <li class="nav__item -hecto -menu">
                        <a href="classes.html" data-letters="Classes">
                            <span>Classes</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="zones.html" data-letters="Zones &amp; equipment">
                            <span>Zones &amp; equipment</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="social.html" data-letters="Social">
                            <span>Social</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="blog.html" data-letters="Blog">
                            <span>Blog</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="careers.html" data-letters="Careers">
                            <span>Careers</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="https://easygym.zendesk.com/hc/en-gb" data-letters="Help &amp; FAQ">
                            <span>Help &amp; FAQ</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="contact.html" data-letters="Get in touch">
                            <span>Get in touch</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu">
                        <a href="gym-rules.html" data-letters="Gym rules">
                            <span>Gym rules</span>
                        </a>
                    </li>
                    <li class="nav__item -hecto -menu -last">
                        <a href="franchise.html" data-letters="Franchise">
                            <span>Franchise</span>
                        </a>
                    </li>
        ...
        <main class="site-main" id="main">
            <section class="site-section home-hero-reduced-fees">
                <div class="home-hero-reduced-fees__link" href="locations.html">
                    <h1 class="home-hero-reduced-fees__title"><span class="home-hero-reduced-fees__intro">Train. Sweat.
                            Laugh.</span><span class="home-hero-reduced-fees__tagline">From £12.99 a month</span></h1>
                    <div class="home-hero-reduced-fees__footer">
                        <p>Premium Kit. Free Classes. No Contract.</p>
                    </div>
                    <div class="text--center"><a href="locations.html" class="btn -large -fill">Join now</a> </div>
                </div>
            </section>
            <section class="site-section intro-area">
                <div class="intro-area__inner">
                    <div class="home-intro-body">
                        <p><em>Free</em> PACK45 Classes, Premium Gym Equipment And No Contract &#8211; The Ultimate
                            Package Deal. <em>Sorted.</em></p>
                    </div>
                    <a href="https://memberzone.easygym.co.uk/login" class="btn -large -fill">
                        <span>Join Online</span>
            ...
            <section class="site-section nav-blocks-container home-nav-blocks-container">
                <nav class="nav nav-blocks -four-blocks">
                    <div class="nav-blocks__block">
                        <div class="nav-blocks__content -cta -user">
                            <h2 class="-beta"><a href="inductions.html">goal based Inductions!</a></h2>
                            <p>Get results!</p><a href="inductions.html" class="btn -medium -fill">
                                <span>Read More!</span>
                                <span class="svg-chevron-right" data-grunticon-embed></span>
                            </a>
                        </div>
                    </div>
                    <div class="nav-blocks__block">
                        <div class="nav-blocks__content -cta -sync">
                            <h2 class="-beta"><a href="https://memberzone.easygym.co.uk/join.htm">Re-join now</a></h2>
                            <p>Welcome back!</p><a href="https://memberzone.easygym.co.uk/login.aspx"
                                class="btn -medium -fill">
                    ...
                    <div class="nav-blocks__block">
                        <div class="nav-blocks__content -cta -ticket">
                            <h2 class="-beta"><a href="https://memberzone.easygym.co.uk/join.htm">Buy a Day Pass</a>
                            </h2>
                            <p>Give us a go!</p><a href="https://memberzone.easygym.co.uk/join.htm"
                                class="btn -medium -fill">
                    ...
                    <div class="nav-blocks__block">
                        <div class="nav-blocks__content -cta -laptop">
                            <h2 class="-beta"><a href="classes.html">Classes</a></h2>
                            <p>Online timetables</p><a href="classes.html" class="btn -medium -fill">
            ...
            <section class="site-section hero -home-pack js-video-embed resrc bg-img"
                data-src="uploads/crop_image/1920/1000/20180611163449_20180426141442_pack45-1920.jpg">
                <div class="hero__inner">
                    <h2 class="-peta caps text--white">Classes</h2>
                    <p>Industry-leading classes to get you in top shape. All for FREE.</p><a href="classes.html"
            ...
            <div class="hide js-gyms-json-container"></div> <input class="flash-sale-checkbox" id="flash-sale-checkbox"
        ...
        <footer class="site-footer" id="footer">
            <div class="site-container">
                <a href="http://easy.com/" class="icon-logo img--full">
                    <img src="uploads/crop_image/220/162/20170307101751_easyGroup-web-logod41d.png?" width="220"
                        height="162" alt="" /> </a>

                <form action="https://parallax.createsend.com/t/r/s/ulilthk/" method="post"
                ...
                <nav class="site-footer__nav">
                    <ul>
                        ...
                        <li><a href="locations.html">Our Gyms</a></li>
                        <li><a href="pack45.html">PACK45</a></li>
                        <li><a href="classes.html">Classes</a></li>
                        <li><a href="zones.html">Zones &amp; Gym Equipment</a></li>
                    </ul>
                    <ul>
                        <li><a href="social.html">Social</a></li>
                        <li><a href="blog.html">Blog</a></li>
                        <li><a href="careers.html">Careers</a></li>
                        <li><a href="https://easygym.zendesk.com/">Help &amp; FAQs</a></li>
                    </ul>
                </nav>
                ...
                <ul class="site-footer__social">
                    ...
                    <!-- <li><a href="https://uk.pinterest.com/easygym/" target="_blank" class="svg-social_pinterest" data-grunticon-embed>Pinterest</a></li> -->
                </ul>
                <div class="site-footer__baseline">
                    <hr class="hr" />
                    <p>© 2017 easyGym. <a href="privacy-policy.html">Privacy Policy</a> | <a href="gym-rules.html">Gym
                            Rules</a> | <a href="terms-and-conditions.html">Terms and Conditions</a> | Website by <a
                            href="https://parall.ax/">Parallax &#8211; Digital Agency Leeds &amp; London</a></p>
                </div>
            </div>
        </footer>
        <div class="overlay">
